...
export const PHYSICAL_TESTS_MADRID: PhysicalTest[] = [
  {
    id: 'test1',
    name: 'Lanzamiento de Balón Medicinal',
    description: 'Lanzamiento hacia adelante con dos manos de un balón medicinal de 3 kg (mujeres) o 5 kg (hombres), sentado/a en el suelo. Mide la fuerza explosiva del tren superior y tronco.'
  },
  {
    id: 'test2',
    name: 'Salto de Longitud Horizontal',
    description: 'Salto horizontal a pies juntos desde parado. Mide la fuerza explosiva del tren inferior.'
  },
  {
    id: 'test3',
    name: 'Carrera de Velocidad (60 metros)',
    description: 'Carrera de 60 metros lisos desde parado. Mide la velocidad de desplazamiento y la capacidad de aceleración.'
  },
  {
    id: 'test4',
    name: 'Carrera de Resistencia (2.000 metros)',
    description: 'Carrera de 2.000 metros lisos. Mide la resistencia aeróbica y la capacidad de mantener un esfuerzo prolongado.'
  }
];
...
export const ICONS: { [key: string]: React.ReactElement } = {
    ...
    physicalTests: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
    ...
    download: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110